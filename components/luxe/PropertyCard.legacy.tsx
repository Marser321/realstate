...
import { MapPin, Bed, Bath, Maximize2, Heart, ArrowUpRight } from 'lucide-react';
    ...
    return (
        ...
        >
            <Link href={`/property/${property.id}`}>
                <article
                    className="property-card group relative bg-card rounded-2xl overflow-hidden border border-border/50 hover:border-[#D4AF37]/30 transition-all duration-500"
